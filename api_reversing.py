...
def signUpnDump(regdata): # dumping shit loads in dem database
    # missing cookie uid cannot be null -> header ?? mitmproxy & see recaf xxx/xxxxxxxxxxx/data/entities/request/auth/SignUpRequest
    # token=x; refresh_token=x; userid=x; -> xxx/xxxxxxxxxxx/data/entities/response/auth/AuthResponse
